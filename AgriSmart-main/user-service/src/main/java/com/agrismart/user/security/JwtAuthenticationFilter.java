        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                if (jwtUtils.validateToken(jwt, userEmail)) {
                    ...
                    // Prefix role with ROLE_ for Spring Security role checks
                    String springSecurityRole = "ROLE_" + role;
                    
                    UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
                            userEmail,
                            userId, // Storing User ID in credentials
            ...
            // Token parsing or validation failed, just proceed (request remains unauthenticated)
        }
